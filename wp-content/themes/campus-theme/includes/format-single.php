<article id="post-<?php the_ID(); ?>" <?php post_class( 'clearfix' ); ?>>	
	...
	<?php if(ot_get_option('show_title_post') != "off" ) : ?>
		<h1 class="<?php echo $title_class; ?>"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h1>
	<?php endif; ?>


	<?php if(ot_get_option('show_title_hr_post') != "off" ) : ?>
		<hr class="page-title-hr" />
	<?php endif; ?>

	
	<?php if(ot_get_option('show_post_meta_post') != "off" ) : ?>

		<div class="entry-meta"> 				
			<div class="meta-string">

				<?php if(ot_get_option('show_format_post') != "off" ) : ?>
					<span class="format-icon"><i class="gen-enclosed foundicon-page" title="Standard Post"></i></span>
				<?php endif; ?>

				<?php if(ot_get_option('show_author_post') != "off" ) : ?>
					<span class="bullet">●</span>
					<?php the_author_posts_link(); ?>
				<?php endif; ?>

				<?php if(ot_get_option('show_date_post') != "off" ) : ?>
					<span class="bullet">●</span>						
					<?php the_time('F j, Y'); ?>
				<?php endif; ?>

				<?php if(ot_get_option('show_categories_post') != "off" ) : ?>
					<span class="bullet">●</span>
					<?php the_category(' ') ?>
				<?php endif; ?>

				<?php if(ot_get_option('show_comments_count_post') != "off" ) : ?>
					<span class="bullet">●</span>			
	...
	<?php if(ot_get_option('show_sub_meta_hr_post') != "off" ) : ?>
		<hr class="sub-meta-hr" />
	<?php endif; ?>
	
	<?php if(ot_get_option('show_featured_post') != "off" ) : ?>
	...
	if ( is_single() ) : ?>
		...
		<?php if(ot_get_option('show_footer_post') != "off" ) : ?>

			<?php if(ot_get_option('show_author_box_post') != "off" ) : ?>
			...
			<?php if(ot_get_option('show_comments_post') != "off" ) : ?>
	...
	<!-- TAGS SPACE -->	
	<?php if(ot_get_option('show_footer_post') != "off" ) : ?>
		<?php if(ot_get_option('show_tags_post') == "on" ) : ?>
